...
compute_kgz_smam.py
-------------------
Compute female SMAM for Kyrgyzstan from MICS6 2018 women's file (kyz.wm.sav)
...
Source: UNICEF MICS6 Kyrgyzstan 2018, women's questionnaire microdata
Result: Kyrgyzstan female SMAM = 21.40

Run from repo root:  python analysis/compute_kgz_smam.py
Reads:               data/raw/kyz.wm.sav
...
df, meta = pyreadstat.read_sav("data/raw/kyz.wm.sav")
print(f"Loaded kyz.wm.sav: {df.shape[0]} rows")
...
print(f"\n>>> Kyrgyzstan female SMAM (MICS6 2018): {SMAM:.2f}")
print(f"    Previous (UN WMD 2019): 21.2 (year 2014)")
